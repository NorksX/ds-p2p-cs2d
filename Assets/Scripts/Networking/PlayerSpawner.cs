...
/// <summary>
/// Spawns and manages networked players for all connected peers
/// </summary>
public class PlayerSpawner : MonoBehaviour
{
    ...
    public void SpawnLocalPlayer(int playerPosition)
    {
        ...
        networkedPlayer.isLocalPlayer = true;
    ...
    /// <summary>
    /// Spawn a remote player (for clients connecting to host)
    /// </summary>
    ...
    private Vector3 GetSpawnPosition(int playerPosition)
    {
        ...
        // Default spawn positions if no spawn points set
